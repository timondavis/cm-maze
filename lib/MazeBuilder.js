...
var MazeBuilderExitPlacement_1 = require("./MazeBuilder/MazeBuilderExitPlacement");
var InternalExitsStrategy_1 = require("./MazeBuilder/ExitPlacementBehavior/InternalExitsStrategy");
var ExternalExitsOpenStrategy_1 = require("./MazeBuilder/ExitPlacementBehavior/ExternalExitsOpenStrategy");
var ExternalExitsSealedStrategy_1 = require("./MazeBuilder/ExitPlacementBehavior/ExternalExitsSealedStrategy");
/**
 * @class MazeBuilder
 *
...
var MazeBuilder = /** @class */ (function () {
     ...
     * @param configs : any
     */
    function MazeBuilder(configs) {
        if (configs === void 0) { configs = null; }
    ...
    MazeBuilder.prototype.placeExits = function () {
        var exitsStrategy;
    ...
    MazeBuilder.prototype.normalizeNodeCoordinates = function () {
        ...
        var dimensionsUsed = this.maze.getNodeWithId("Origin").location.dimensions;
        ...
        var _loop_1 = function (i) {
            Object.keys(this_1.maze.getNodes()).forEach(function (key) {
                currentValue = _this.maze.getNodeWithId(key).location.getAxisPoint(i);
    ...
    MazeBuilder.prototype.getDimensions = function () {
        var _this = this;
        var dimensionsUsed = this.entry.location.dimensions;
        var node;
        var currentValue;
        var maxValue;
        var minValue;
