...
var MazeBuilder = /** @class */ (function () {
    ...
    MazeBuilder.prototype.buildMaze = function () {
        ...
        this.occupiedLocations = {};
        this.entry = new MazeNode_1.MazeNode(this.cardinality);
        this.nodeCounter++;
     ...
     */
    MazeBuilder.prototype.getNodeCollection = function () {
    ...
    MazeBuilder.prototype.tryNodeConnectionFromEveryAvailableExit = function (pointer, openConnectionPoints) {
        ...
        for (var i = 0; i < openConnectionPoints.length; i++) {
            var index = MazeBuilder.rand(openConnectionPoints.length, 0);
    ...
    MazeBuilder.prototype.hopToNextNode = function (pointer) {
        return pointer.getNeighborAt(MazeBuilder.rand(this.cardinality.getConnectionPointCount(), 0));
    };
    /**
    ...
    MazeBuilder.prototype.getNextNodeAtExit = function (pointer, exitPoint) {
        ...
        if (this.occupiedLocations.hasOwnProperty(nextCoordinates.toString())) {
            ...
            tempNextNode.setMaxExits(MazeBuilder.rand(this.cardinality.getConnectionPointCount(), 1));
            this.nodeCounter++;
    ...
    MazeBuilder.prototype.normalizeNodeCoordinates = function () {
        ...
        var dimensionsUsed = this.getNodeCollection()["[0,0]"].getCoordinates().getDimensions();
        ...
        var _loop_1 = function (i) {
            Object.keys(this_1.getNodeCollection()).forEach(function (key) {
                currentValue = _this.getNodeCollection()[key].getCoordinates().getAxisPoint(i);
        ...
        var _loop_2 = function (i) {
            Object.keys(this_2.getNodeCollection()).forEach(function (key) {
                currentNode = _this.getNodeCollection()[key];
        ...
        // O(n)
        Object.keys(this.getNodeCollection()).forEach(function (key) {
            currentNode = _this.getNodeCollection()[key];
    ...
    MazeBuilder.prototype.getDimensions = function () {
        ...
        var _loop_3 = function (i) {
            maxValue = 0;
            minValue = 0;
            Object.keys(this_3.getNodeCollection()).forEach(function (key) {
                node = _this.getNodeCollection()[key];
    ...
    MazeBuilder.prototype.selectRandomNode = function () {
        var coordinateList = Object.keys(this.getNodeCollection());
