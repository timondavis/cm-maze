    ...
    MazeRenderer.prototype.render2D = function () {
        ...
        for (var x = 0; x < this.maze.getDimensions()[X]; x++) {
            for (var y = 0; y < this.maze.getDimensions()[Y]; y++) {
                var node = this.maze.getNodeAtLocation(new NodeLocation2D_1.NodeLocation2D([x, y]));
                ...
                for (var i = 0; i < cardinality; i++) {
                    ...
                    var neighborNodeId = node.getNeighborIdAt(i);
                    neighborNode = this.maze.getNodeWithId(neighborNodeId);
                    var neighborCoordinates = neighborNode.location.position;
