    ...
    MazeRenderer.prototype.render2D = function () {
        ...
        for (var x = 0; x < this.maze.getDimensions()[X]; x++) {
            for (var y = 0; y < this.maze.getDimensions()[Y]; y++) {
                var node = this.maze.getNode(new MazeCoordinates2D_1.MazeCoordinates2D([x, y]));
                ...
                else if (this.maze.getFinishNode() && node.getCoordinates() === this.maze.getFinishNode().getCoordinates()) {
                ...
                for (var i = 0; i < cardinality; i++) {
                    ...
                    var neighborCoordinates = neighborNode.getCoordinates().getPosition();
