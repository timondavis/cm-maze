...
describe('MazeNode', function () {
    ...
    it('accepts and respects limits to the amount of nodes that this node can be connected to', function () {
        ...
        var _loop_1 = function (i) {
            chai_1.expect(function () { unlimited.connectTo(new MazeNode_1.MazeNode(new CardinalityBehaviorFour2D_1.CardinalityBehaviorFour2D()), i); })
                .not.to.throw();
            //
            if (i < 1) {
                chai_1.expect(function () { limitedToOne.connectTo(new MazeNode_1.MazeNode(new CardinalityBehaviorFour2D_1.CardinalityBehaviorFour2D()), i); })
                    .not.to.throw();
            }
            else {
                chai_1.expect(function () { limitedToOne.connectTo(new MazeNode_1.MazeNode(new CardinalityBehaviorFour2D_1.CardinalityBehaviorFour2D()), i); })
            ...
            if (i < 3) {
                chai_1.expect(function () { limitedToThree.connectTo(new MazeNode_1.MazeNode(new CardinalityBehaviorFour2D_1.CardinalityBehaviorFour2D()), i); })
                    .not.to.throw();
            }
            else {
                chai_1.expect(function () { limitedToThree.connectTo(new MazeNode_1.MazeNode(new CardinalityBehaviorFour2D_1.CardinalityBehaviorFour2D()), i); })
