...
describe('MazeNode', function () {
    ...
    it('can store and retrieve contents on each node', function () {
        var n = new MazeNode_1.MazeNode(new Compass4_1.Compass4());
        var actors = new Map();
        var numbers = new Map();
        var widgets = new Map();
        actors.set('1', new cm_dungeon_1.Actor());
        actors.set('2', new cm_dungeon_1.Actor());
        actors.set('3', new cm_dungeon_1.Actor());
        ...
        chai_1.expect(n.contents.get('actors').get('1').labels.get('name')).to.be.equal('1');
        chai_1.expect(n.contents.get('actors').get('2').labels.get('name')).to.be.equal('2');
        chai_1.expect(n.contents.get('actors').get('3').labels.get('name')).to.be.equal('3');
        chai_1.expect(n.contents.get('numbers').get(1)).to.be.equal(1);
        chai_1.expect(n.contents.get('numbers').get(2)).to.be.equal(2);
        chai_1.expect(n.contents.get('numbers').get(3)).to.be.equal(3);
        chai_1.expect(n.contents.get('widgets').get('1')).to.be.equal('1');
        chai_1.expect(n.contents.get('widgets').get('2')).to.be.equal('2');
        chai_1.expect(n.contents.get('widgets').get('3')).to.be.equal('3');
    });
});
