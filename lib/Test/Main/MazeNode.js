...
describe('MazeNode', function () {
    ...
    it('connects bidirectionally to each node by default, but can be done in directed graph fashion', function () {
        ...
        var a = new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()).setLocation(new NodeLocation2D_1.NodeLocation2D([0, 0]));
        var b = new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()).setLocation(new NodeLocation2D_1.NodeLocation2D([0, 1]));
        var c = new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()).setLocation(new NodeLocation2D_1.NodeLocation2D([1, 0]));
    ...
    it('can be explicitly named', function () {
        var m = new Maze_1.Maze();
        var a = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4);
        a.setName("My Name");
        chai_1.expect(a.getName()).to.be.equal("My Name");
    });
    it('can report on who its neighboring nodes are', function () {
        var m = new Maze_1.Maze();
        var a = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4(), new NodeLocation2D_1.NodeLocation2D([0, 0])).setName("A");
        var b = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4(), new NodeLocation2D_1.NodeLocation2D([1, 0])).setName("B");
        var c = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4(), new NodeLocation2D_1.NodeLocation2D([0, -1])).setName("C");
        var d = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4(), new NodeLocation2D_1.NodeLocation2D([0, 1])).setName("D");
        m.addNode(a.getLocationId(), a);
        m.addNode(b.getLocationId(), b);
        m.addNode(c.getLocationId(), c);
    ...
    it('can report on what its occupied exit points are', function () {
        var m = new Maze_1.Maze();
        var a = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setName("A").setLocation(new NodeLocation2D_1.NodeLocation2D([0, 0]));
        var b = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setName("B").setLocation(new NodeLocation2D_1.NodeLocation2D([-1, 0]));
        var c = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setName("C").setLocation(new NodeLocation2D_1.NodeLocation2D([1, 0]));
        var d = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setName("D").setLocation(new NodeLocation2D_1.NodeLocation2D([0, 1]));
        m.addNode(a.getLocationId(), a);
        m.addNode(b.getLocationId(), b);
        m.addNode(c.getLocationId(), c);
        m.addNode(d.getLocationId(), d);
    ...
    it('can report on what its open exit points are', function () {
        ...
        var a = new MazeNode_1.MazeNode(m, new Compass8_1.Compass8());
        a.connectTo(new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()), Compass8_1.C8.N);
        a.connectTo(new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()), Compass8_1.C8.E);
        a.connectTo(new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()), Compass8_1.C8.S);
        a.connectTo(new MazeNode_1.MazeNode(m, new Compass8_1.Compass8()), Compass8_1.C8.W);
    ...
    it('confirms whether another supplied node is neighbors with this node', function () {
        var m = new Maze_1.Maze();
        var a = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setLocation(new NodeLocation2D_1.NodeLocation2D([0, 0]));
        var b = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setLocation(new NodeLocation2D_1.NodeLocation2D([0, -1]));
        var c = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setLocation(new NodeLocation2D_1.NodeLocation2D([-1, -1]));
        var d = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()).setLocation(new NodeLocation2D_1.NodeLocation2D([-1, 0]));
        m.addNode(a.getLocationId(), a);
        m.addNode(b.getLocationId(), b);
        m.addNode(c.getLocationId(), c);
        m.addNode(d.getLocationId(), d);
        ...
        d.connectTo(c, Compass4_1.C4.NORTH); // Illogical position should still connect (it is allowed).
        chai_1.expect(a.isNeighborsWith(b)).to.be.true;
    ...
    it('reports on whether a given exit point on the node is occupied or empty (two separate functions)', function () {
        var m = new Maze_1.Maze();
        var a = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4());
        var b = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4());
        var c = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4());
        a.connectTo(b, Compass4_1.C4.NORTH);
    ...
    it('accepts and respects limits to the amount of nodes that this node can be connected to', function () {
        var m = new Maze_1.Maze();
        var unlimited = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4());
        var limitedToOne = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4());
        var limitedToThree = new MazeNode_1.MazeNode(m, new Compass4_1.Compass4());
        limitedToOne.setMaxConnections(1);
        limitedToThree.setMaxConnections(3);
        var _loop_1 = function (i) {
            chai_1.expect(function () { unlimited.connectTo(new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()), i); })
                .not.to.throw();
            //
            if (i < 1) {
                chai_1.expect(function () { limitedToOne.connectTo(new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()), i); })
                    .not.to.throw();
            }
            else {
                chai_1.expect(function () { limitedToOne.connectTo(new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()), i); })
            ...
            if (i < 3) {
                chai_1.expect(function () { limitedToThree.connectTo(new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()), i); })
                    .not.to.throw();
            }
            else {
                chai_1.expect(function () { limitedToThree.connectTo(new MazeNode_1.MazeNode(m, new Compass4_1.Compass4()), i); })
