...
describe('MazeBuilder', function () {
    ...
    it('will never create a room with all exits sealed', function () {
        var mb4 = new MazeBuilder_1.MazeBuilder({ cardinality: new Compass4_1.Compass4(), complexity: 150 });
        var mb8 = new MazeBuilder_1.MazeBuilder({ cardinality: new Compass8_1.Compass8(), complexity: 150 });
