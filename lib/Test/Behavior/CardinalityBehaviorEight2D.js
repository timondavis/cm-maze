...
const Compass8_2 = require("../../Behavior/Compass8");
describe('Compass8', () => {
    let cb8 = new Compass8_2.Compass8();
    ...
    it('can validate a position number (referring to an exit on the node), ' +
        ...
        chai_1.expect(() => cb8.validateConnectionPoint(0)).not.to.throw();
        chai_1.expect(() => cb8.validateConnectionPoint(-1)).to.throw();
        chai_1.expect(() => cb8.validateConnectionPoint(7)).not.to.throw();
        chai_1.expect(() => cb8.validateConnectionPoint(8)).to.throw();
    });
