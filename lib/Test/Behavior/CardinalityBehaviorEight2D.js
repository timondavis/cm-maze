...
describe('Compass8', function () {
    ...
    it('can generate new neighboring coordinate objects, given a current coordinate object and a desired direction', function () {
        ...
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.NORTH).getPosition().toString()).to.be.equal([0, -1].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.NE).getPosition().toString()).to.be.equal([1, -1].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.EAST).getPosition().toString()).to.be.equal([1, 0].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.SE).getPosition().toString()).to.be.equal([1, 1].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.SOUTH).getPosition().toString()).to.be.equal([0, 1].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.SW).getPosition().toString()).to.be.equal([-1, 1].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.WEST).getPosition().toString()).to.be.equal([-1, 0].toString());
        chai_1.expect(cb8.getNextLocation(spot, Compass8_1.C8.NW).getPosition().toString()).to.be.equal([-1, -1].toString());
    });
});
